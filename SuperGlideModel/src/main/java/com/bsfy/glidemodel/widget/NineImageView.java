...
public class NineImageView extends ViewGroup {
    ...
    private void init(Context context) {
        cellWidth = cellHeight = ScreenUtils.dp2px(context, 60);
        setMargin(3);
    ...
    public void setData(List<ImageData> data, LayoutHelper layoutHelper) {
        ...
        size = ScreenUtils.getSize(data);
        if (size > MAX_IMAGE_SIZE) {
            size = MAX_IMAGE_SIZE;
            data.get(MAX_IMAGE_SIZE - 1).text = "+" + String.valueOf(ScreenUtils.getSize(data) - MAX_IMAGE_SIZE);
        }
    ...
    public NineImageView setMargin(int margin) {
        this.margin = ScreenUtils.dp2px(getContext(), margin);
        return this;
    }
    ...
    public NineImageView setRoundCornerRadius(int roundCornerRadius) {
        this.roundCornerRadius = ScreenUtils.dp2px(getContext(), roundCornerRadius);
        return this;
    }
