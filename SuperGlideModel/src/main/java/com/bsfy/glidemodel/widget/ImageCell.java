package com.bsfy.glidemodel.widget;
...
import com.bsfy.glidemodel.progress.GlideApp;
import com.bsfy.glidemodel.util.ScreenUtils;
...
public class ImageCell extends ImageView {
    ...
    private void init() {
        ...
        cornerIconMargin = ScreenUtils.dp2px(getContext(), 3);
    ...
    private void initCornerIcon() {
        ...
        if (cornerIconDrawable != null) {
            cornerIconWidth = ScreenUtils.dp2px(getContext(), cornerIconDrawable.getIntrinsicWidth());
            cornerIconHeight = ScreenUtils.dp2px(getContext(), cornerIconDrawable.getIntrinsicHeight());
    ...
    public Drawable getGifDrawable() {
        if (gifDrawable == null) {
            gifDrawable = ScreenUtils.getTextDrawable(getContext().getApplicationContext(), 24, 14, 2, "GIF", 11, R.color.nine_image_text_background_color);
        }
        return gifDrawable;
    }
    ...
    public Drawable getLongDrawable() {
        if (longDrawable == null) {
            longDrawable = ScreenUtils.getTextDrawable(getContext().getApplicationContext(), 25, 14, 2, "长图", 10, R.color.nine_image_text_background_color);
        }
        return longDrawable;
    }
    ...
    public ImageCell setTextSize(int size) {
        textPaint.setTextSize(ScreenUtils.dp2px(getContext(), size));
