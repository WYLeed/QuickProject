package com.bsfy.realproject.utils
 ...
 * Date: 2018-09-30
 */
class XPreference<T>(private val keyName: String, private val default: T) {

    private val prefs: SharedPreferences by lazy { Utils.getApp().getSharedPreferences(keyName, Context.MODE_PRIVATE) }
